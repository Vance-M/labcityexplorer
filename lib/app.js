...
const { formatLocation, formatWeather, formatBusiness } = require('./munging-utils.js');
...
app.get('/reviews', async(req, res) => {
  try {
    ...
    const businessData = await request
      ...
      .set({ 'Authorization': 'Bearer AbEK3SJlclGB84GIBUk4TgkBN0j_x4LCk40ff-t4NOiBl1m0sXZiDUfkOF7Yb7jEoI7pDfFZBkf8I_209mqtypZ8VeqsXfLwmmy1V37zNUyR2bBo1hcR1OGV5Z02YHYx' });

    const id = businessData.body.businesses[0].id;
    const businessReviewData = await request
      .get(`https://api.yelp.com/v3/businesses/${id}/reviews`)
      .set({ 'Authorization': 'Bearer AbEK3SJlclGB84GIBUk4TgkBN0j_x4LCk40ff-t4NOiBl1m0sXZiDUfkOF7Yb7jEoI7pDfFZBkf8I_209mqtypZ8VeqsXfLwmmy1V37zNUyR2bBo1hcR1OGV5Z02YHYx' });
    console.log(businessReviewData.body.reviews[0]);
    res.json(businessData.body.businesses);
  } catch (e) {
